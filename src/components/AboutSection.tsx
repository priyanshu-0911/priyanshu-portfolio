...
>
  ...
  >
    ...
    <h2 className="max-w-4xl text-4xl font-semibold tracking-tight text-text-primary sm:text-5xl lg:text-6xl">
      Developer. Builder.
      <br />
      <span className="text-text-muted">Always experimenting.</span>
    </h2>
  </motion.div>
  ...
  <div className="grid items-center gap-12 sm:gap-16 lg:grid-cols-[0.85fr_1.15fr] lg:gap-24">
    ...
    >
      <p className="text-lg leading-8 text-text-secondary sm:text-xl">
        I&apos;m Priyanshu Ramchandani, a developer focused on building
        modern web experiences and full-stack applications.
      </p>
      ...
      <p className="mt-6 text-base leading-8 text-text-secondary">
        ...
        actually use. My work currently revolves around React, Next.js,
        TypeScript, backend systems and real-world integrations.
      </p>

      <p className="mt-6 text-base leading-8 text-text-secondary">
        I&apos;m also constantly experimenting with new technologies,
        particularly AI, interactive interfaces and better ways to build
      ...
      <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3">
        <div className="rounded-xl border border-border bg-surface/50 p-4">
          <p className="font-mono text-xl text-text-primary">2026</p>
        ...
        <div className="rounded-xl border border-border bg-surface/50 p-4">
          <p className="font-mono text-xl text-text-primary">Full-Stack</p>
          <p className="mt-1 text-xs text-text-muted">
            Development
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-surface/50 p-4">
          <p className="font-mono text-xl text-text-primary">∞</p>
          <p className="mt-1 text-xs text-text-muted">
            Things to build
          </p>
        </div>
